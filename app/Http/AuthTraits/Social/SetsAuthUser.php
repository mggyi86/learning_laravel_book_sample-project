...
trait SetsAuthUser
{
    ...
    private function setSocialUserName($socialUser){
        switch ($this->provider){
            case 'github' :
                is_null($socialUser->name)? $this->userName = $socialUser->nickname : $this->userName = $socialUser->name;
                break;
            case 'facebook' :
                $this->userName = $socialUser->name;
                break;
            default :
                is_null($socialUser->name)? $this->userName = $this->createUserName() : $this->userName = $socialUser;
                break;
        }
    }
